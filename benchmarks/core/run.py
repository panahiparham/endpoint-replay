"""
Run: the weekly benchmark suite (DQN on Acrobot/MountainCar/Cartpole/Pinball-easy/
Catch).

Cheat sheet:
    Plan: uv run benchmarks/core/run.py plan
    Sweep: uv run benchmarks/core/run.py sweep --num-workers 5 --slurm
    Single: uv run benchmarks/core/run.py single --component dqn_catch
